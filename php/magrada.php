            ...
            <ul class="navbar-nav mr-lg-2">
              <li class="nav-item nav-search d-none d-lg-block">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control inputBuscar" id="buscarNom" placeholder="Buscar cançó" aria-label="search" aria-describedby="search" onkeyup="buscarNomCanço();">
                </div>
              </li>
            </ul>
            ...
            <div class="content-wrapper mainCFons extraEspai">
                ...
                <div class="col-md-12 grid-margin">
                  <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                      <h3 id="nomCategoria" class="textIniciClient">M'agrada</h3>
                    </div>
                    <div class="col-12 col-xl-4">
                      <div class="justify-content-end d-flex">
                        <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                          <form method="post">
                            <select name="filtrar" id="filtrarPer" class="css_inputsLogReg selectFiltrar custom-select" onchange="aplicarFiltre();">
                            ...
                            <input type="button" value="Eliminar filtre" class="btn btn-sm btn-light btnAfegirC btnFiltrarP" onclick="mostrar_like_canciones();">
                          </form>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="modal-body cosModal">
                      <form>
                        <div class="form-group">
                          ...
                          <input id="idHiddenn" type="hidden">
              ...
              <div class="row">
                <div class="col-md-12 grid-margin modificarGridMargin">
                  <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                      <h4 id="nomCategoria" class="musicaTexts">Cançons que m'agraden</h4>
                    </div>
                  </div>
                </div>
              </div>
              <div class="row" id="cançons">
