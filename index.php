                ...
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card divCategoria">
                        <div class="card-body imatgeMusica cat1">
                            ...
                            <audio src="uploads/2a63edcb4f7bd958e2921c1eb6ec0b26.mp3" preload="metadata" id="audio-1"></audio> <!-- audio-id Donde id sea el id de la canción inserido mediante query -->
                            <div class="media divMedia">
                                <div class="media-body zonaBotonsMusica">
                                    <span class='bx bx-play-circle play' id="play" onclick="play(1)"></span> <!-- play(id) Donde id sea el id de la canción inserido mediante query -->
