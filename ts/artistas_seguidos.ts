            ...
            if (select == 0) {
                ...
                for (var i = 0; i < select2.length; i++) {
                    if (select2[i].getElementsByTagName("usr")[0].childNodes[0].nodeValue == id) {
                        ...
                        //     //<img src="..img/'+select2[i].getElementsByTagName("imatge")[0].childNodes[0].nodeValue+select2[i].getElementsByTagName("tipus")[0].childNodes[0].nodeValue'" alt="imatgePerfil">
